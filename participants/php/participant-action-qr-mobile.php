...
<head>
    ...
    <title>Participant Sign Attendance Mobile</title>
...
<!-- side bar -->
    ...
    <div class="participant-icon-container">
        ...
        <a class="icon-link active sidebar-icon" href="participant-action-submit-mobile.php" aria-label="Scan / Log Action">
