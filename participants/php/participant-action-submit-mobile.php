...
<body>
    ...
    <nav class="side-bar" role="navigation" aria-label="Main">
        <div class="participant-icon-container">
            ...
            <a class="icon-link active sidebar-icon" href="participant-action-submit-mobile.php"
            ...
            <div class="submit-container">
                ...
                <div class="submit-image">
                    <label class="image-upload-box" for="imageInput">
                        ...
                        <span class="upload-text" id="uploadText">Tap to upload image</span>
                        <input type="file" id="imageInput" name="upload_file" style="display:none;" required>
                    </label>
                </div>
                <!-- optional description -->
                <div class="submit-description">
                    <textarea placeholder="Add a description... (Optional)" name="challenge_notes"></textarea>
                </div>
            </div>
            <!-- submit -->
