...
<body>
    ...
    <div class="article-container">
        ...
        <p>
            UK businesses and households produce 1.45 million tonnes of e-waste a year. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>

        <h2>Tip 1: Buy Less</h2>
        <p>Only purchase devices you really need. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>

        <h2>Tip 2: Recycle Properly</h2>
        <p>Always drop old electronics at certified recycling points. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
