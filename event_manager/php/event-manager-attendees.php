...
<head>
    ...
    <link rel="stylesheet" href="../css/event-manager-attendees.css">
...
<!-- side bar -->
    ...
    <div class="participant-icon-container">
        ...
        <a class="icon-link active sidebar-icon" href="event-manager-calendar.php" aria-label="Challenges">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><label class="switch">
                                <input type="checkbox"
                                    name="attendance[<?php echo $row['participants_id']; ?>]"
                                    value="1"
