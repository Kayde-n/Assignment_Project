...
<body>
    ...
    <div class="impact">
        ...
        <div class="impact-dropdown">
            <button class="impact-dropdown-btn">
                <span>Daily</span> <span class="arrow-icon">▼</span>
            </button>
        </div> 
    ...
    <div class="news-card">
        <a href="participant-econews-example-mobile.php" class="news-link"> 
            ...
            <div class="news-content">
                ...
                <h3 class="news-title">
                    Campus Green Challenge Launched
                </h3>
